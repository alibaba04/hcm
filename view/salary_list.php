                    ...
                    <div class="active tab-pane" id="activity">
                        ...
                        <div class="table-responsive mailbox-messages">
                            <table class="table table-hover table-striped">
                                ...
                                $q = "SELECT ab.nik,um,transport,komunikasi,Year(tanggal) as years,month(tanggal) as month,COUNT(CASE WHEN (scan1)<time( '".$jmasuk."' ) and if(scan6='00:00:00',if(scan5='00:00:00',if(scan4='00:00:00',if(scan3='00:00:00',scan2,scan3),scan4),scan5),scan6)>if(DAYNAME(tanggal)='Saturday','".$jsabtu."','".$jpulang."') THEN (scan1) END) AS masuk FROM `aki_absensi`ab left join aki_tunjangan t on ab.nik=t.nik where 1=1 ". $filter1." GROUP by nik";
