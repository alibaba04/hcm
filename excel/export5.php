...
<body>
	...
	header("Content-Disposition: attachment; filename=Data_CUTI_".$years.".xls");
	?>
 
	<center>
		<h1>Export Data CUTI <?php echo $years; ?><br/></h1>
	</center>
 
	<table border="1" class="table">
		<thead class="thead-dark">
			<tr>
				<th style='background: palegreen;' rowspan="2">NIK</th>
				<th style='background: palegreen;' rowspan="2">Name</th>
				<?php 
				for ($i = 1; $i <= 12; ) {
					$dateObj   = DateTime::createFromFormat('!m', $i);
					$monthName = $dateObj->format('F'); 
					echo "<th style='background: palegreen;' colspan='2'>".$monthName."</th>";
					$i++;
				} 
				?>
			</tr>
			<tr>
				<?php 
				for ($i = 1; $i <= 12; ) {
					echo "<th style='background: palegreen;'>CT</th>";
					echo "<th style='background: palegreen;'>CM</th>";
					$i++;
    			}	
    			?>	 
			</tr>
