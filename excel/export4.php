...
<body>
	...
	header("Content-Disposition: attachment; filename=Data_Izin2_".$years.".xls");
	?>
 
	<center>
		<h1>Export Data IZIN 1/2 Hari <?php echo $years; ?><br/></h1>
	</center>
	...
	<table border="1" class="table">
		...
		<tbody>
			...
			$qt='SELECT nik,Year(tanggal) as years,month(tanggal) as month ,jenis,COUNT(nik) as jml FROM `aki_izin`WHERE aktif=1 and jenis ="Izin 1/2 Hari" and year(tanggal)='.$years.' GROUP by month,nik';
